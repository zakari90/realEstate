...
import { ArrowLeft, ArrowRight, SearchX, TrendingUp } from "lucide-react";
...
function Page() {
  ...
  const totalPages = Math.ceil(investmentsData.length / rowsPerPage);
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 pb-20">
      ...
      <div className="relative bg-gradient-to-br from-teal-900 via-teal-800 to-emerald-900 py-20 overflow-hidden mb-12">
        ...
        <div className="container relative mx-auto px-4 text-center z-10">
          ...
          <div className="text-white drop-shadow-md">
            <PageHeader>فرص الاستثمار العقاري</PageHeader>
          </div>

          <p className="text-teal-100 text-lg max-w-2xl mx-auto mt-4 leading-relaxed font-light">
            اكتشف أحدث الفرص الاستثمارية وابدأ رحلة نمو ثروتك العقارية مع شركاء
            موثوقين
          </p>
        </div>
      </div>
        ...
        {loading ? (
                  ...
                  <PaginationContent className="gap-4">
                    <PaginationItem>
                      <Button
                        ...
                        className="rounded-full hover:bg-teal-50 hover:text-teal-600 transition-all disabled:opacity-30"
                      >
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center bg-white rounded-3xl shadow-sm border border-gray-100 mx-auto max-w-2xl">
            <div className="bg-gray-50 p-6 rounded-full mb-6 relative overflow-hidden group">
              <div className="absolute inset-0 bg-teal-100/50 scale-0 group-hover:scale-100 transition-transform duration-500 rounded-full" />
              <SearchX className="w-16 h-16 text-gray-400 relative z-10 transition-colors group-hover:text-teal-600" />
            </div>
            <h3 className="text-2xl font-bold text-gray-900 mb-3">
              لا توجد فرص استثمارية حاليا
            </h3>
            <p className="text-gray-500 max-w-md mx-auto leading-relaxed">
              لم نتمكن من العثور على أي فرص استثمارية متاحة في الوقت الحالي.
              يرجى التحقق مرة أخرى لاحقًا أو التواصل معنا.
            </p>
          </div>
        )}
      </section>
