...
type Step = {
  ...
  const steps : Step[] = [
...

      {
        ...
        icon: Book,
        content: "قبل أن تبدأ رحلتك في شراء المنزل، من الضروري أن تقوم بتثقيف نفسك حول العملية. ابدأ بالبحث عن سوق الملكيات المحلي وتعرف على الشروط القانونية للمعاملات العقارية. يمكنك مشاهدة مقاطع فيديو تعليمية على يوتيوب أو استشارة مختص في الملكيات للحصول على رؤى قيمة. ستساعدك هذه التحضيرات على اتخاذ قرارات مدروسة أثناء العملية."
      },
      {
        title: "اختر العقار الذي يعجبك",
        icon: Home,
        content: "بمجرد أن تكون على دراية بالمعلومات، ابدأ في استكشاف الملكيات المتاحة. قم بإنشاء قائمة بالميزات الأساسية والمرافق التي ترغب فيها. استخدم منصات الملكيات عبر الإنترنت أو تعاون مع وكيل عقاري. لا تتعجل في هذه العملية - خصص وقتًا للعثور على منزل يناسب احتياجاتك وميزانيتك."
      },
      {
        title: "قدم عرضك للبائع",
        icon: FileText,
        content: "عندما تجد العقار المناسب، حان الوقت لتقديم عرضك. يجب أن يعكس عرضك—الذي يحدد السعر وفترة الدفع—قيمة عادلة بناءً على الملكيات المماثلة في المنطقة. بعد تقديم العرض، سيتواصل معك البائع عادةً في غضون ثلاثة إلى خمسة أيام لإبلاغك ما إذا كان قد قبل عرضك."
      },
      {
